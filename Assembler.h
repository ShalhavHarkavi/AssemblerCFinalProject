...
#include <string.h>
#include <ctype.h>
#define MAX_NAME_LENGTH 32 /*Maxmimum name length according to the project guidelines +1 for '\0'*/
...
typedef enum ErrorCode{fopenError, syntaxError, nameError, lineLengthError, fileNumError/*Add more error types here*/}errorCode; /*Error codes for calling the error function*/
